...
class AlmophireDataRetrieved: NSObject{
  ...
  movieObj.append(movie(poster:urlValue.url+poster!,title: title!,overview:overview!, release_date: release_date!, id:id!, user_rate:user_rate!))
